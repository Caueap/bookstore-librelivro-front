<template class="t">
    <div class="maindiv">
        <div class="content-div">
                                ...
                                <v-row>
                                    <v-col cols="12" sm="12">
                                        <v-list-item three-line class="mt-10">
                                            <v-list-item-content>
                                                <div class="mb-4">
                                                    <v-icon x-large color="white">mdi-book-open-blank-variant</v-icon>
                                                </div>
                                                <v-list-item-subtitle> Livros </v-list-item-subtitle>
                                                <v-list-item-title class="mb-1" color="#fff">129 </v-list-item-title>
                                                <strong></strong>
                                            </v-list-item-content>
                                        </v-list-item>
                                    </v-col>
            ...
            <v-row>
                <v-col cols="12" md="6" lg="6" xl="6" xs="12">
                    <BarChart />
                </v-col>
            </v-row>
        </div>
