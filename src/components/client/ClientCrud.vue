                    ...
                    <v-card>
                        ...
                        <v-card-text>
                            <v-form class="px-3" ref="form">
                                <v-text-field label="Nome da editora" v-model="client.name"
                                    :rules="[rules.required, rules.minLength, rules.maxLength]"></v-text-field>
                                <v-text-field label="Cidade da editora" v-model="client.city" :rules="[rules.required, rules.minLength, rules.maxCityLength]">
                                </v-text-field>
                            </v-form>
                        </v-card-text>
                        <v-card-actions>
...
export default {
    ...
    // computed: {
    //     formTitle() {
    //         return this.index === -1 ? 'Nova usuário' : 'Editar usuário'
    //     }
